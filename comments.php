...
<?php if ( have_comments() ) : ?>
	<h3 id="comments"><?php comments_number('Be the first to comment&hellip;', 'One comment', '% comments' );?></h3>
...
<?php if ( comments_open() ) : ?>
	...
	<h3 id="respond"><?php comment_form_title( 'Leave a comment', 'Leave a reply to %s' ); ?></h3>
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<p class="admin">Logged in as <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a> / <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="Log out of this account">Log out</a></p>
